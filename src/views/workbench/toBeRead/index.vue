  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column align="center" label="待阅事项" prop="dysx" :show-overflow-tooltip="true">
          <template slot-scope="scope">
            <el-link type="primary" :underline="false">{{scope.row.dysx}}</el-link>
          </template>
        </el-table-column>
    ...
    return {
      ...
      fields: [
        ...
        },
        {
          ...
          label: '待阅事项',
          render: (data) => (
            <el-input placeholder="待阅事项" vModel={data['dysx']} />
          ),
        },
        {
          field: 'djlx',
